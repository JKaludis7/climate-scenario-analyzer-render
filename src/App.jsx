  ...
  const run = useCallback(async () => {
    ...
    try {
      ...
      const r2 = await callAPI(SYS,
        'Model climate scenario impacts for '+cn+' ('+t+'), industry: '+(d1.industry||"unknown")+'. Scope 1 '+(d1.emissions?.scope1||"unknown")+', Scope 2 '+(d1.emissions?.scope2||"unknown")+', Scope 3 '+(d1.emissions?.scope3||"unknown")+'. Net-zero: '+(d1.netZeroTarget||"unknown")+'. Physical exposure: '+(d1.physicalExposure||"unknown")+'.\n\nModel THREE scenarios: 1.5C (Paris-aligned), 2C (delayed transition), 3C+ (hot house). Be concise. 1 factor per risk area. 1-sentence details only.\n\nReturn JSON:\n{"scenarios":{"s15":{"summary":"2-sentence impact summary","physical":{"score":4,"level":"Low-Moderate","factors":[{"name":"key factor","detail":"1 sentence"}]},"transition":{"score":6,"level":"Moderate-High","factors":[{"name":"key factor","detail":"1 sentence"}]},"financial":{"score":5,"level":"Moderate","factors":[{"name":"key factor","detail":"1 sentence"}]},"regulatory":{"score":5,"level":"Moderate","detail":"1 sentence"},"opportunity":{"score":7,"level":"High","detail":"1 sentence"},"revenueAtRisk":5,"capexRequired":12,"carbonCost":4},"s20":{"summary":"2-sentence summary","physical":{"score":6,"level":"Moderate","factors":[{"name":"f","detail":"1 sentence"}]},"transition":{"score":5,"level":"Moderate","factors":[{"name":"f","detail":"1 sentence"}]},"financial":{"score":6,"level":"Moderate","factors":[{"name":"f","detail":"1 sentence"}]},"regulatory":{"score":4,"level":"Low-Moderate","detail":"1 sentence"},"opportunity":{"score":5,"level":"Moderate","detail":"1 sentence"},"revenueAtRisk":14,"capexRequired":8,"carbonCost":10},"s30":{"summary":"2-sentence summary","physical":{"score":8,"level":"High","factors":[{"name":"f","detail":"1 sentence"}]},"transition":{"score":2,"level":"Low","factors":[{"name":"f","detail":"1 sentence"}]},"financial":{"score":7,"level":"High","factors":[{"name":"f","detail":"1 sentence"}]},"regulatory":{"score":2,"level":"Low","detail":"1 sentence"},"opportunity":{"score":3,"level":"Low","detail":"1 sentence"},"revenueAtRisk":25,"capexRequired":4,"carbonCost":20}},"timeline":[{"year":"2025","s15":8,"s20":10,"s30":12},{"year":"2030","s15":18,"s20":25,"s30":35},{"year":"2035","s15":25,"s20":40,"s30":55},{"year":"2040","s15":30,"s20":52,"s30":72},{"year":"2045","s15":34,"s20":62,"s30":85},{"year":"2050","s15":36,"s20":70,"s30":95}],"executiveSummary":"2-3 sentence overall strategic assessment"}'
      );
